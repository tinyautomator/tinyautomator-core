    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          title: 'font-medium',
          description: 'text-xs text-muted-foreground mt-0.5 whitespace-pre-wrap break-words',

          actionButton:
            'bg-primary text-primary-foreground text-xs px-2 py-1 rounded-md font-medium',
          cancelButton: 'bg-muted text-muted-foreground text-xs px-2 py-1 rounded-md font-medium',
          closeButton:
