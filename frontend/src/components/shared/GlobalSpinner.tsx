  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center backdrop-blur-sm z-[9999]">
      ...
      <div className="animate-[spin_4s_linear_infinite_reverse]">
        <Settings className="w-16 h-16 text-gray-6bnv00 fill-white dark:text-gray-600 " />
      </div>
      <div className="relative top-8 right-3.5 animate-[spin_4s_linear_infinite]">
        <Settings className="w-8 h-8 text-amber-600 fill-white dark:text-amber-600 dark:fill-white" />
      </div>
    </div>
  );
}
