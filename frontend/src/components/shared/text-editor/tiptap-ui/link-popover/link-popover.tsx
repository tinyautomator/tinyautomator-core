...
// --- Icons ---
import { CornerDownLeftIcon } from "@/components/shared/text-editor/tiptap-icons/corner-down-left-icon";
import { ExternalLinkIcon } from "@/components/shared/text-editor/tiptap-icons/external-link-icon";
import { LinkIcon } from "@/components/shared/text-editor/tiptap-icons/link-icon";
import { TrashIcon } from "@/components/shared/text-editor/tiptap-icons/trash-icon";
...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@/components/shared/text-editor/tiptap-ui-primitive/popover";
import { Separator } from "@/components/shared/text-editor/tiptap-ui-primitive/separator";

// --- Styles ---
import "@/components/shared/text-editor/tiptap-ui/link-popover/link-popover.scss";
