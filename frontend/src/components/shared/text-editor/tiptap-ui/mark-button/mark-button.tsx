...
// --- Icons ---
import { BoldIcon } from "@/components/shared/text-editor/tiptap-icons/bold-icon";
import { Code2Icon } from "@/components/shared/text-editor/tiptap-icons/code2-icon";
import { ItalicIcon } from "@/components/shared/text-editor/tiptap-icons/italic-icon";
import { StrikeIcon } from "@/components/shared/text-editor/tiptap-icons/strike-icon";
import { SubscriptIcon } from "@/components/shared/text-editor/tiptap-icons/subscript-icon";
import { SuperscriptIcon } from "@/components/shared/text-editor/tiptap-icons/superscript-icon";
import { UnderlineIcon } from "@/components/shared/text-editor/tiptap-icons/underline-icon";
...
import {
  Button,
  ButtonProps,
} from "@/components/shared/text-editor/tiptap-ui-primitive/button";
