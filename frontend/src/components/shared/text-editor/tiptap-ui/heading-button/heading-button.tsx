...
// --- Icons ---
import { HeadingOneIcon } from "@/components/shared/text-editor/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@/components/shared/text-editor/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@/components/shared/text-editor/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@/components/shared/text-editor/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@/components/shared/text-editor/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@/components/shared/text-editor/tiptap-icons/heading-six-icon";
