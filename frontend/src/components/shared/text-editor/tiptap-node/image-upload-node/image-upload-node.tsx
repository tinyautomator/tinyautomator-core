...
import { CloseIcon } from "@/components/shared/text-editor/tiptap-icons/close-icon";
import "@/components/shared/text-editor/tiptap-node/image-upload-node/image-upload-node.scss";
