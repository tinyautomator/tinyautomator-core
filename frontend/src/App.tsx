          ...
          <section className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
            <h1 className="text-6xl md:text-8xl font-bold mb-8 text-white mr-37 text-left">
              ...
              <span className="inline-block relative">
                <GearIcon ref={firstGearRef} className={gearClass} style={gearStyle} />
              </span>
              mat
              <span className="inline-block relative">
                <GearIcon ref={secondGearRef} className={gearClass} style={gearStyle} />
              </span>
              r
            </h1>
          ...
          <div className="py-20 px-4 md:px-8 max-w-7xl mx-auto">
            {blocks.map((block, index) => (
              ...
              >
                ...
                <div
                  className={cn('w-full md:w-1/2', index % 2 === 1 ? 'text-right' : 'text-left')}
                >
