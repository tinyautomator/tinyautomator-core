...
export const blockCategories = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: FileText,
        node_type: 'trigger',
        description: 'Begin a workflow when a file is uploaded to a specified location',
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        icon: FileText,
        node_type: 'action',
        description: 'Generate a new task or to-do item in a task management system',
      },
      {
      ...
      },
      {
        ...
        icon: Shield,
        node_type: 'action',
        description: 'Establish a secure OAuth connection with an external service',
      },
      {
      ...
      },
      {
        ...
        icon: Mail,
        node_type: 'action',
        description: 'Automatically send a welcome email to newly created users',
      },
      {
