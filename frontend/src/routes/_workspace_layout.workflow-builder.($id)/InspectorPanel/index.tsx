      ...
      >
        <Button
          ...
          className={cn(
            ...
            toggleInspectorPanel ? 'h-10 w-10 rounded-full' : 'h-13 w-13 rounded-l-full'
          )}
      ...
      >
        ...
        >
          <div className="h-1/15 pl-5 flex flex-col justify-between">
            ...
            <p className="pb-2 text-xs text-muted-foreground">Configure the selected block</p>
          </div>
          <Separator />
          <ScrollArea className="h-[calc(100vh-8.5rem)]">
            {selectedNode ? (
              ...
              <div className="flex h-full flex-col items-center justify-center p-6 text-center text-slate-500">
                ...
                <p className="mt-1 text-xs">Select a block on the canvas to configure it</p>
              </div>
            )}
          </ScrollArea>
        </div>
